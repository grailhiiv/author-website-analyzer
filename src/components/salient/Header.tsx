  ...
  return (
    <Popover>
      ...
      >
        ...
        <MobileNavLink href="/#testimonials">Use cases</MobileNavLink>
        <MobileNavLink href="/#pricing">Plans</MobileNavLink>
        <hr className="m-2 border-slate-300/40" />
        <MobileNavLink href="/admin/login">Admin sign in</MobileNavLink>
      </PopoverPanel>
    </Popover>
  )
}
        ...
        <nav className="relative z-50 flex justify-between">
          <div className="flex items-center md:gap-x-12">
            ...
            <div className="hidden md:flex md:gap-x-6">
              ...
              <NavLink href="/#testimonials">Use cases</NavLink>
          ...
          <div className="flex items-center gap-x-5 md:gap-x-8">
            ...
            <Button href="/analyze" color="blue">
              <span>
                Analyze <span className="hidden lg:inline">website</span>
              </span>
            </Button>
