...
- Calibrate automated observations against approved live sites and anonymized offline fixtures before promoting another design observation into scoring. AI may explain confirmed evidence in author-friendly language but may not decide whether a design is good or determine a score.
