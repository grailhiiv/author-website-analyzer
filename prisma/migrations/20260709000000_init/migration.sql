...
-- CreateEnum
CREATE TYPE "ReportCategory" AS ENUM ('BRAND_CLARITY', 'BOOK_VISIBILITY', 'READER_ENGAGEMENT', 'SEARCH_VISIBILITY', 'MOBILE_PERFORMANCE', 'TECHNICAL_HEALTH', 'AUTHOR_TRUST', 'SITE_USABILITY');
